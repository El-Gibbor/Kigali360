...
```
lib/
├── main.dart                        # App entry: Firebase init, Provider setup, auth gate
├── firebase_options.dart            # Auto-generated by FlutterFire CLI
│
├── models/
│   ├── listing_model.dart           # ListingModel: fields + Firestore toMap/fromMap
│   ├── user_model.dart              # UserModel: uid, email, displayName
│   └── user_profile.dart
│
├── services/
│   ├── auth_service.dart            # Firebase Auth wrapper (ChangeNotifier)
│   └── firestore_service.dart       # Firestore CRUD + real-time streams (ChangeNotifier)
│
├── screens/
│   ├── main_wrapper.dart            # Bottom navigation shell (4 tabs)
│   ├── login_screen.dart            # Login UI
│   ├── signup_screen.dart           # Sign-up UI
│   ├── directory_screen.dart        # All listings + search + category filter
│   ├── my_listings_screen.dart      # Current user's listings only
│   ├── map_screen.dart              # flutter_map overview with listing markers
│   ├── listing_detail_screen.dart   # Detail + WebView map + Navigate FAB
│   ├── add_listing_screen.dart      # Create / Edit listing form (shared)
│   └── settings_screen.dart        # User profile header + sign out
│
└── theme/
